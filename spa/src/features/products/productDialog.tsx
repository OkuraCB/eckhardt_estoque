...
import { IModel, listModels, selectModels } from "../models/modelsSlice";
...
const acceptTypes = ".pdf, .jpeg, .jpg, .png";

export const DocumentDialog = ({ onClose, open, tab }: ProductDialogProps) => {
	...
	const handleSendDisabled = () => (name && price && qty)!;
			...
			>
				...
				<DialogContent>
					<Grid
						container
						spacing={2}
						sx={{ maxHeight: "50vh", justifyContent: "center" }}
					>
						<Grid size={{ xs: 10 }}>
							<TextField
								label="Nome"
						...
						<Grid size={{ xs: 6 }}>
							<Autocomplete
								...
								options={collections}
								renderInput={(params) => (
									<TextField {...params} label="Coleção" />
								)}
