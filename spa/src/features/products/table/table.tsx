...
import { deleteProduct, IProduct, listProducts, selectProducts } from "../productSlice";
...
export const ProductsTable = ({setProductDialog, setSaleDialog}: ITableProps) => {
     ...
     const columns = useMemo<MRT_ColumnDef<IProduct>[]>(
        () => [
            ...
            },
            {
                ...
                Cell: ({renderedCellValue, row}) => row.original.price ? (<>R$ {renderedCellValue}</>) : (<>Sem Preço</>)
